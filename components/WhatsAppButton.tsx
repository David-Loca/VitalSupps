...
export default function WhatsAppButton({
  ...
  const primaryStyles =
    "bg-accent-blue text-white hover:bg-accent-blue-dark shadow-md hover:shadow-card-hover";
  const secondaryStyles =
    "bg-white text-accent-blue border-2 border-accent-blue hover:bg-light-gray";
